...
HD_PWD='/home/zynq-user/Industri-University_Course/Git/Zynq-Learning/zynq-tutorials/zynqbook_chapter2b/zynqbook_chapter2.runs/design_1_axi_timer_0_0_synth_1'
cd "$HD_PWD"
