...
0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0}\
  ...
  connect_bd_net -net and_gate_0_dout [get_bd_pins and_gate_0/dout] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports LD0] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net din0_0_1 [get_bd_ports SW0] [get_bd_pins and_gate_0/din0]
  connect_bd_net -net din1_0_1 [get_bd_ports SW1] [get_bd_pins and_gate_0/din1]
